...
public class LoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        coordinatorLayout = findViewById(R.id.snackbar_login_activity);
                    ...
                    .addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                        ...
                        public void onComplete(@NonNull Task<AuthResult> task) {
                            ...
                            if (user!= null){
                                        ...
                                        .addSnapshotListener(new EventListener<QuerySnapshot>() {
                                            ...
                                            public void onEvent(@Nullable QuerySnapshot queryDocumentSnapshots,
                                                ...
                                                if (!queryDocumentSnapshots.isEmpty()) {
                                                    ...
                                                    progressBar.setVisibility(View.INVISIBLE);
                                                    Log.d("LoginActivity", "onEvent: "+ "document empty ");
                                                }
                                ...
                                Snackbar.make(LoginActivity.this, coordinatorLayout ,
                                        "User Credentials Invalid.", Snackbar.LENGTH_SHORT)
                                        .show();
//                                Toast.makeText(LoginActivity.this, "User Credentials Invalid.", Toast.LENGTH_SHORT).show();
                    ...
                    .addOnFailureListener(new OnFailureListener() {
                        ...
                        public void onFailure(@NonNull Exception e) {
                            progressBar.setVisibility(View.INVISIBLE);
                            Log.d("LoginActivity", "onFailure: "+ "sign in Failure ");
                        }
                    });
